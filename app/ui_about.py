...
class Ui_AboutDialog(object):
    ...
    def retranslateUi(self, AboutDialog):
        ...
        self.lab_version.setText(
            _translate(
                "AboutDialog",
                '<html><head/><body><p><span style=" font-size:16pt; font-weight:600;">openocd-svd vx.x</span></p></body></html>',
            )
        )
        self.label_2.setText(
            _translate(
                "AboutDialog", "OpenOCD and CMSIS-SVD based\nperipheral register viewer"
            )
        )
        self.label_3.setText(
            _translate("AboutDialog", "Author: Eden Synrez <esynr3z@gmail.com>")
        )
